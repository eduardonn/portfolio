...
import Expandable from "../../common_components/Expandable";
import { HomePageContent, HomePageSection, HomePageTitle } from "./HomePageBase";

const AboutMeSection: Component = () => {
  return (
    <HomePageSection>
      <HomePageTitle>About Me</HomePageTitle>
      <HomePageContent>
        <p>
        ...
        <Expandable>
          <HomePageTitle>My Story</HomePageTitle>
          <HomePageContent>
            <p>
            ...
            <p>
              When I was around 15, I realized that one doesn't need to be a wizard to learn about programming and I tried learning myself. Even though I wasn't very successful at that time, I ended up falling in love with the potential of computers, more specifically, games, visual effects, optimization, physics simulations, online applications and, specially, the potential of reaching the whole world with a good idea.
            </p>
          </HomePageContent>
        </Expandable>
      </HomePageContent>
