  ...
  return (
    <ProjectPageBase projectIndex={projectIndex}>
      ...
      <ProjectContentSection>
        <p>
          Despite this portfolio being relatively simple, I think there are some things worth mentioning about it.
        </p>
      </ProjectContentSection>
      ...
      <ProjectContentSection title='Design'>
        <p>
          I'm clearly not a designer, but since this is a personal website, I tried my best to show what I have. And for the theme choice, I went with summer vibes just because I think it looks good.
        </p>
      </ProjectContentSection>
